...
$(document).ready(function () {
  ...
  $("button#b_piercing").click(function () {
    ...
    const textArray = ["Target suffers maximum damage and 1d2 Dexterity damage. Target’s movement speeds are reduced by half until healed.<br>Save: A DC 20 Constitution negates; deals bonus damage instead.<br>Heal: A DC 20 Heal check ends the movement penalty.",
  ...
  $("button#m_piercing").click(function () {
    ...
    const textArray = ["Target suffers maximum damage and 1d3 Dexterity damage. Target’s movement speeds are reduced by half until healed.<br>Save: A DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check ends the movement penalty.",
  ...
  $("button#s_piercing").click(function () {
    ...
    const textArray = ["Target suffers maximum damage plus bonus damage again and 1d4 Dexterity damage. Target’s movement speeds are reduced by half until healed.<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: A DC 30 Heal check ends the movement penalty.",
