...
$(document).ready(function() {
  $("button#btnG_Melee").click(function() {
    ...
    "Attack the Darkness<br>Your attack fails and all of your enemies are considered to have concealment from you (20% miss chance) for 1d4 rounds.<br>Save: Resolve DC 20 negates.<br>Recover: You may continue to make a Resolve save each round you are affected to end the duration.",
    "Awkward Attack<br>Your attack fails and you take a -2 penalty to Defense rolls for 1d4 rounds.<br>Save: Dexterity DC 20 negates.<br>Recover: You must expend a greater action to recover.<br>Special: If using a two-handed weapon, add +1 round to the duration of the penalty.",
    "Backswing<br>Reroll the attack with yourself as the target; it is possible to critically hit yourself in this manner.<br>Save: Dexterity DC 20 negates.<br>Special: You may defend against this attack as normal but may not negate the attack (such as a counter, block, or parry) if it is successful.",
    "Bad Grip<br>Your attack fails and you weapon deals nonlethal damage for the next 3 rounds.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a standard action to fix your grip and end the nonlethal damage.",
    "Bent<br>Your attack fails and you weapon deals nonlethal damage for the next 3 rounds.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a standard action to fix your grip and end the nonlethal damage.",
    "Better to Give<br>Your attack hits and damages you instead. Use your target’s Str modifier when calculating the damage.<br>Save: Dexterity DC 20 negates.<br>Special: Reroll attack to determine if you critically hit yourself. This reroll cannot miss or fumble.",
    "Bohemian Earspoon<br>Your attack fails and you are deafened until healed.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check ends the deafened condition.",
    "Bonk<br>Your attack fails and you are stunned until the end of your next turn.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check removes the stun effect.<br>Special: If wielding a bludgeoning weapon, you are stunned for 1d4 rounds instead.",
    "Broken Blade<br>Your attack hits and deals damage to your weapon instead of your target.<br>Save: Dexterity DC 20 negates.<br>Recover: A Craft DC 20 check is needed to repair the damage.<br>Special: If you do not wield a weapon, damage is dealt to yourself instead.",
    "Broken Haft<br>Your attack fails and your weapon suffers bonus damage. The weapon suffers a -2 penalty on attack rolls and loses the reach property until repaired.<br>Save: Dexterity DC 20 negates.<br>Recover: A DC 20 Craft Weapons check repairs the weapon.<br>Special: If you are not wielding a reach weapon, your attack hits and deals damage to your weapon instead.",
    "Butterfingers<br>Your attack fails and you drop your weapon.<br>Save: Dexterity DC 20 negates.<br>Recover: You must expend a standard action to pick up your weapon. This provokes an attack of opportunity from threatening foes.<br>Special: If using a light weapon, it is flung 1d6 squares away instead.",
    "Catastrophic Failure<br>Your attack fails and you fall unconscious for 1d6 rounds.<br>Save: Resolve DC 20 negates.<br>Recover: You may make a new saving throw each round.<br>Special: If wielding a bludgeoning weapon, add 2 rounds to the duration.",
    "Catch Your Breath<br>Your attack fails and you become staggered until the end of your next turn.<br>Save: Constitution DC 20 negates.<br>Special: If wielding a two-handed weapon or wearing heavy armor, add one round to the duration.",
    "Critical Mistake<br>The attack hits and deals damage to you instead and is considered a critical threat. Determine the severity of the critical hit as normal.<br>Save: Dexterity DC 20 negates.<br>Special: You do not defend against this attack and may not negate the attack (such as a counter, block, or parry).",
    "Cutter<br>Your attack fails and you take 1 point of Str bleed.<br>Save: Dexterity DC 20 negates.<br>Heal: A DC 20 Heal check ends the Str bleed. Rest or restorative magic is needed to heal the ability damage.<br>Special: If you are wielding a slashing weapon, this increases the Str bleed to 2.",
    "Eat Dirt<br>Your attack fails and you fall prone and are blinded for 1d3 rounds.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a standard action to stand up from being prone, and a standard action to wipe the debris from your eyes.",
    "Fling<br>Your attack fails and you throw your weapon where it lands 1d6 squares away in a random direction.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a standard action to retrieve your weapon after you move to its location.<br>Special: If wielding a light weapon, add +1 square to the distance traveled.",
    "Fog of War<br>Your attack fails and you threaten no squares for 1d6 rounds.<br>Save: Resolve DC 20 negates.<br>Recover: Expend a greater action to regain your senses and composure.<br>Special: If you are below half hit points, you suffer disadvantage on this saving throw.",
    "Funny Bone<br>Your attack fails and you drop whatever is in your off hand.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a standard action to retrieve your item.<br>Special: If that item is a light weapon, it is flung 1d6 squares away instead.",
    "Go for the Eyes<br>Your attack fails and you are blinded until the end of your next turn.<br>Save: Dexterity DC 20<br>Heal: A Heal check DC 20 removes the blinded condition.<br>Special: If you are using a piercing weapon, add 1d3 rounds of blindness.",
    "Hand It Over<br>Your attack fails and your target gains possession of your weapon.<br>Save: Dexterity DC 20 negates.<br>Special: If wielding a two-handed weapon, you gain advantage on your saving throw.",
    "I Told You It Was Sharp<br>Your attack fails and you suffer 1d6 points of bleed damage.<br>Save: Dexterity DC 20<br>Heal: Curative magic or a DC 20 Heal check heals.<br>Special: If you are using a slashing or piercing weapon, add +2 points of bleed.",
    "Notched<br>Your attack fails and your weapon suffers bonus damage.<br>Save: Dexterity DC 20 negates.<br>Repair: A Craft skill check of DC 20 is required to repair the damage inflicted.<br>Special: If wielding a two-handed weapon, it bonus damage again.",
    "Off Balance<br>Your attack fails and you suffer disadvantage on all attack rolls until the end of your next turn.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a greater action to gather your balance and composure.<br>Special: If wielding a two-handed weapon, add one round to the duration.",
    "Overextended<br>Your attack fails and you provoke an attack of opportunity from all opponents who threaten you.<br>Save: Dexterity DC 20 negates.",
    "Parry! Dodge! Spin! Thrust!<br>Your attack fails and you are dazed until the end of your next turn.<br>Save: Resolve DC 20 negates.<br>Recover: Expend a greater action to gather your balance and composure.",
    "Pin Prick<br>Your attack fails and you take 1d4 points of Bleed damage.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check ends the bleed effect.<br>Special: If wielding a piercing weapon, add +2 additional points of bleed.",
    "Pointy End Goes There<br>Your attack fails and you take 1 point of Con damage.<br>Save: Dexterity DC 20 negates.<br>Heal: Rest or restorative magic.<br>Special: If wielding a piercing weapon, add 1 point of additional Con damage.",
    "Pulled Muscle<br>Your attack fails and you take 1d4 points of Str damage.<br>Save: Constitution DC 20 negates.<br>Heal: Rest or restorative magic.",
    "Punt<br>Your attack fails and your weapon flies 2d6 squares in a random direction.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a standard action to retrieve your weapon from its location.<br>Special: If wielding a light weapon, add +1 square to the distance traveled.",
    "Second Thoughts<br>Your attack fails and you are sickened for 1d6 rounds.<br>Save: Resolve DC 20 negates.<br>Recover: You may continue to make a save each round to end the effect.<br>Special: If you are shaken or frightened, you suffer disadvantage on your saving throw.",
    "Slipped<br>Your attack fails and you are knocked prone.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend a standard action to stand up from prone (this provokes attacks of opportunity from all threatening foes).",
    "Sorry!<br>Reroll the attack targeting an ally adjacent to you or the original target; it is possible to critically hit yourself or your ally in this manner. If there are no adjacent allies, you target yourself.<br>Save: Dexterity DC 20 negates.<br>Special: If targeting yourself, you may defend against this attack as normal but may not negate the attack (such as a counter, block, or parry) if it is successful.",
    "Spinning Swing<br>Your attack fails and you are sickened for 1d4 rounds.<br>Save: Resolve DC 20 negates.<br>Recover: Expend a greater action to gather your balance and composure.<br>Special: If wielding a two-handed weapon, add +1 round to the duration.",
    "Strain<br>Your attack fails and you take 1d4 points of Dex damage.<br>Save: Constitution DC 20 negates.<br>Heal: Rest or restorative magic.<br>Special: If using a light weapon, reduce the Dex damage to 1d3.",
    "Stuck<br>Your attack fails and your weapon becomes stuck in a nearby surface in your square.<br>Save: Dexterity DC 20 negates.<br>Recover: As a standard action, you must make a successful DC 20 Str check to retrieve your weapon.",
    "Surrounded by Foes<br>The attack hits and deals damage to an ally within reach instead and is considered a critical threat. Determine the severity of the critical hit as normal.<br>Save: Dexterity DC 20 negates.<br>Special: If there are no allies within reach, the attack hits yourself instead. You do not defend against this attack and may not negate the attack (such as a counter, block, or parry).",
    "This is Bad<br>Your attack fails and you take bonus damage as bleed damage.<br>Save: Constitution DC 20 negates.<br>Recover: A Heal check DC 20 removes the bleed condition.",
    "This Sword is Heavy<br>Your attack fails and you become fatigued.<br>Save: Constitution DC 20 negates.<br>Recover: A Heal DC 20 check removes the fatigued condition, as does rest.",
    "Too Much Stuff<br>Your attack fails and you become entangled in your gear.<br>Save: Dexterity DC 20<br>Recover: You must spend a standard action to free yourself.<br>Special: If wielding a tensile weapon (chain, whip, etc.), you suffer disadvantage on your Dexterity save.",
    "Vibration<br>Your attack fails and you strike something solid, suffering 1d3 points of Str damage, and drop your weapon.<br>Save: Constitution DC 20<br>Heal: Rest or restorative magic.<br>Special: If wielding a tensile weapon (chain, whip, etc.), the Str damage drops to 1.",
    "Wait! What?<br>Your attack fails and you become confused for one round.<br>Save: Resolve DC 20 negates. <br>Special: If wielding a bludgeoning weapon, add +1 round to the duration.",
    "Who Was That?<br>Your attack fails and you are grazed by your own weapon becoming dazed for 1d3 rounds.<br>Save: Resolve DC 20<br>Recover: You may make a Resolve save each round to end the effect. A DC 20 Heal check will also remove the effect.<br>Special: If wielding a bludgeoning weapon, add +1 round to the duration.",
    "Wide Open<br>Your attack fails and you become flat-footed until the end of your next turn.<br>Save: Dexterity DC 20 negates",
    "Winded<br>Your attack fails and you become exhausted.<br>Save: Constitution DC 20 negates.<br>Heal: Expend a greater action to regain your wind, removing the exhausted condition.<br>Special: If wearing heavy armor, you must expend a greater action and make a successful DC 20 Constitution save to remove the exhausted condition.",
    "Wrong End<br>Your attack fails and you take bonus damage.<br>Save: Constitution DC 20 negates.<br>Heal: A Heal check DC 20 removes the bleed effect.<br>Special: If using a slashing weapon, you take bonus damage again.",
    "You Meant to Do That<br>Your attack fails and you move 10 feet in a random direction and provoke attacks of opportunity as normal.<br>Save: Dexterity DC 20 negates.<br>Special: If wearing heavy armor, you must suffer disadvantage on your Dexterity save and fall prone on a failed save.",
  ...
  $("button#btnG_Ranged").click(function() {
    ...
    "All Thumbs<br>Your attack fails and you lose your Dex bonus on attack rolls for 3 rounds.<br>Save: Dexterity DC 20 negates.<br>Recover: You must expend a greater action and make a successful DC 20 Acrobatics skill check to regain your Dex bonus.",
    "Amazing Miss<br>Your attack fails and you are stunned until the end of your next turn.<br>Save: Resolve DC 20 negates.",
    "Archer's Elbow<br>Your attack fails and you take a -2 penalty on all ranged attack rolls for 1d4 minutes.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check removes the attack roll penalty.",
    "Awkward Attack<br>Your attack fails and you take a -2 penalty to Defense rolls for 1d4 rounds.<br>Save: Dexterity DC 20 negates.<br>Recover: As a standard action, a successful DC 20 Dexterity save removes the attack roll penalty.",
    "Backfire<br>Reroll the attack with yourself as the target; it is possible to critically hit yourself in this manner.<br>Save: Dexterity DC 20 negates.<br>Special: You may defend against this attack as normal but may not negate the attack (such as a counter, block, or parry) if it is successful.",
    "Bad Alignment<br>Your attack fails and you suffer disadvantage on all attacks with this weapon until repaired.<br>Save: Dexterity DC 20 negates.<br>Repair: A DC 20 Craft Weapon check removes the attack penalty.",
    "Busted<br>Your attack fails and your attack deals damage to your weapon instead of your target.<br>Save: Dexterity DC 20 negates.<br>Recover: A Craft DC 20 check is needed to repair the damage.<br>Special: If you do not wield a weapon, damage is dealt to yourself instead.",
    "Bull's Eye<br>Your attack fails and your shot ricochets near the eye. You take bonus damage and are blinded until the end of your next turn.<br>Save: Dexterity DC 20 negates.<br>Heal: A DC 20 Heal check will remove the blinded condition.",
    "Close to the Ear<br>Your attack fails and you are deafened until healed.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check removes the deafened condition.<br>Special: If using a firearm, the DC increases to 25.",
    "Cracked<br>Your attack fails and your weapon takes bonus damage.<br>Save: Dexterity DC 20 negates.<br>Repair: A DC 20 Craft Weapon check will repair the damage.<br>Special: If you do not wield a weapon, bonus damage is dealt to yourself instead.",
    "Don't Hit Me<br>Your attack fails and you take an additional -2 penalty on ranged attacks for each ally in melee combat with your target for 3 rounds.<br>Save: Resolve DC 20 negates.<br>Recover: Spend a standard action to make a Perception check DC 20 to removes the attack penalty.",
    "Double Miss<br>Your attack fails and you spend twice as much ammunition on this attack.<br>Save: Dexterity DC 20 negates.",
    "Errant Aim<br>Reroll the attack targeting the next nearest creature to the original target; it is possible to critically hit yourself or an ally in this manner. If there are no other creatures, you target yourself.<br>Save: Dexterity DC 20 negates.<br>Special: If targeting yourself, you may defend against this attack as normal but may not negate the attack (such as a counter, block, or parry) if it is successful.",
    "Everything You Got<br>Your attack fails and you become exhausted.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check or rest removes the exhaustion.",
    "Friendly Fire<br>Reroll the attack targeting the next nearest ally to the original target; it is possible to critically hit yourself or an ally in this manner. If there are no other creatures, you target yourself.<br>Save: Dexterity DC 20 negates.<br>Special: If targeting yourself, you may defend against this attack as normal but may not negate the attack (such as a counter, block, or parry) if it is successful.",
    "Head Rush<br>Your attack fails and you become sickened for 1d4 rounds.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check or rest removes the sickened condition.",
    "Huh?<br>Your attack fails and you are confused until the end of your next turn.<br>Save: Resolve DC 20 negates.",
    "In the Line of Fire<br>The attack hits and deals damage to an ally closest to the target instead and is considered a critical threat. Determine the severity of the critical hit as normal.<br>Save: Dexterity DC 20 negates.<br>Special: If there are no allies within reach, the attack hits yourself instead. You do not defend against this attack and may not negate the attack (such as a counter, block, or parry).",
    "Insecure<br>Your attack fails and you suffer a -1 penalty on attack rolls until you score a critical hit.<br>Save: Resolve DC 20 negates.<br>Recover: You must succeed at a Resolve save or score a critical hit to end this affect. You may reroll the save each round.<br>Special: Each attack you miss your target increases the penalty by -1.",
    "Klutz<br>Your attack fails and you drop your weapon in your square.<br>Save: Reflex 20 negates.<br>Recover: You must expend a standard action to pick it up. This provokes attacks of opportunity from all threatening foes.",
    "Lost Grip<br>Your attack fails and you become staggered until the end of your next turn.<br>Save: Dexterity DC 20 negates.",
    "Lost the Target<br>Your attack fails and you suffer disadvantage on all attack rolls until the end of your next turn.<br>Save: Resolve DC 20 negates.",
    "Lowered Guard<br>Your attack fails and you provoke attacks of opportunity from all threatening foes.<br>Save: Dexterity DC 20 negates.<br>Special: If no foes threaten you this round, you instead suffer a -2 penalty to your Defense rolls for 3 rounds.",
    "Misjudged the Distance<br>Your attack fails and all attack rolls beyond the first range increment have triple the normal distance penalty for 3 rounds.<br>Save: Intelligence DC 20 negates.<br>Recover: As a standard action, if you successfully make a Perception DC 20 check, you end the penalty.",
    "Mix it Up<br>Your attack fails and you are unable to make ranged attacks for the next 1d6 rounds.<br>Save: Resolve DC 20 negates.<br>Recover: You must take a greater action to gather your wits and end this effect.",
    "My Spleen!<br>Your attack fails and you take 1 point of Con damage.<br>Save: Constitution DC 20 negates.<br>Heal: Rest or restorative magic.",
    "Nicked<br>Your attack fails and you take 1d6 points of bleed damage.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check ends the bleed effect.",
    "Notched Fingers<br>Your attack fails and you take 1d4 points of bleed and suffer a -2 penalty to ranged attacks while bleeding.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check ends the bleed effect.",
    "Overcompensated<br>Your attack fails and all targets with cover gain advantage to Defense rolls against you for 3 rounds.<br>Save: Wisdom DC 20 negates.<br>Recover: As a standard action, make a successful DC 20 Perception check to overcome their additional cover bonus.",
    "Overshot<br>Your attack fails and you weapon travels 1d4 times its range increment past the target.<br>Save: Dexterity DC 20 negates.<br>Special: If not using a thrown weapon, it instead slips out of your hand landing 1d6 squares in a random direction.<br>Recover: A standard action is required to pick up a weapon in combat, which provokes attacks of opportunity.",
    "Phantom Wind<br>Your attack fails and you compensate for a breeze which isn’t there. You take a -2 penalty on ranged attack rolls for 3 rounds.<br>Save: Wisdom DC 20 negates.<br>Recover: As a standard action, make a successful DC 20 Survival check to end the attack penalty.",
    "Pinched in Parts<br>Your attack fails and you take 1d2 points of Dex damage <br>Save: Dexterity DC 20 negates.<br>Heal: Rest or restorative magic.",
    "Recoil<br>Your attack fails and you move backward 1 square and fall prone.<br>Save: Constitution DC 20 negates.<br>Recover: You must expend a standard action to stand up from a prone position. This provokes attacks of opportunity from all threatening foes.",
    "Seeing Double<br>Your attack fails and all your attacks have a 50% miss chance until the end of your next turn.<br>Save: Resolve DC 20 negates.<br>Recover: As a standard action, make a successful DC 20 Perception check to end the miss chance.",
    "Shot your Foot<br>Your attack fails and you suffer bonus damage. Your speed is reduced by half until healed.<br>Save: Dexterity DC 20 negates.<br>Heal: Rest or restorative magic.",
    "Snapped Component<br>Your attack fails and a minor part of your weapon jams or breaks and requires 1d3 rounds to fix.<br>Save: Dexterity DC 20 negates.<br>Recover: A successful Craft Weapon DC 20 check is required to repair.",
    "So Much Blood<br>Your attack fails and you are sickened for 1d6 rounds.<br>Save: Resolve DC 20 negates.<br>Heal: A successful Heal DC 20 check removes the sickened condition.",
    "Spilled Ammo<br>Your attack fails and your ammunition falls from its weapon or container and takes 1d6 rounds to gather up.<br>Save: Dexterity DC 20 negates.<br>Recover: Expend 1d6 rounds gathering the ammo, or switch to another weapon or ammo container if possible.",
    "Sprain<br>Your attack fails and you take 1d4 points of Dex damage.<br>Save: Constitution DC 20 negates.<br>Heal: Rest or restorative magic.",
    "Tied Up<br>Your attack fails and you become entangled in your gear.<br>Save: Dexterity DC 20 negates.<br>Recover: You must spend a standard action to free yourself.",
    "Torn Tendon<br>Your attack fails and you take 1 point of Dex bleed.<br>Save: Constitution DC 20 negates.<br>Heal: A DC 20 Heal check ends the bleed effect. Rest or restorative magic is needed to heal ability damage.",
    "Umm, Oops<br>Reroll the attack with yourself as the target; it is possible to critically hit yourself in this manner.<br>Save: Dexterity DC 20 negates.<br>Special: You may defend against this attack as normal but may not negate the attack (such as a counter, block, or parry) if it is successful.",
    "Weapon Jam<br>Your attack fails and your weapon suffers bonus damage. If using a projectile weapon it ceases to function until repaired.<br>Save: Dexterity DC 20 negates.<br>Recover: A Craft DC 20 check is needed to repair the damage.<br>Special: If you do not wield a weapon, damage is dealt to yourself instead.",
    "What Are The Odds?<br>Reroll the attack targeting the next nearest creature to the original target; it is possible to critically hit yourself or an ally in this manner. If there are no other creatures, you target yourself.<br>Save: Dexterity DC 20 negates.<br>Special: If you made a thrown attack, you hit the original target, but the weapon ends up in the target’s possession. If targeting yourself, you may defend against this attack as normal but may not negate the attack (such as a counter, block, or parry) if it is successful.",
    "Whoops!<br>Your attack fails and you are knocked prone.<br>Save: Dexterity DC 20 negates.<br>Recover: You must expend a standard action to stand from prone. This provokes attacks of opportunity from all threatening opponents.",
    "Wide Open<br>Your attack fails and you are flat-footed until the end of your next turn.<br>Save: Dexterity DC 20 negates.",
    "Wrong Weapon<br>Your attack fails and you grab a random object from your gear instead of your intended weapon or ammunition.<br>Save: Resolve DC 20 negates.<br>Recover: Expend a standard action to retrieve the correct item.",
    "How In The World?<br>The attack hits and deals damage to the original target and the opponent may not negate the attack (such as a counter, block, or parry). This attack may not critically hit or cause any special effects (such as from a Strike maneuver)"    
    ];
