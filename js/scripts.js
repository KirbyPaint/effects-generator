...
function effect(title, text, charClass, randomNumber, difficulty) {
  ...
  $(".text").prepend(
    `<p class="${difficulty}">${getTime()}<br><img src=${image} class="time"><br>${
      randomNumber + 1
    }: <em>${title[randomNumber]}</em><br>${text[randomNumber]}</p>`
  );
}
...
function popupText(title, text, randomNumber) {
  $(".popup-text").empty();
  $(".popup-text").append(
    `<span class="popup-title-text">${title[randomNumber]}</span><p>${text[randomNumber]}</p>`
  );
  $(".popup").slideDown();
  $(".text").show();
}
...
$(document).ready(function () {
  ...
  $("button#g_ranged").click(function () {
    ...
    const textArray = [
      "Your attack fails and you become fatigued.<br>Save: Constitution DC 20 negates.<br>Recover: Heal check DC 20 or rest for 8 hours.<br>Special: If wearing heavy armor or wielding a heavy crossbow, you suffer disadvantage to your save.",
  ...
  $("button#g_natural").click(function () {
    ...
    const textArray = [
      "Your attack fails and you suffer a -2 penalty to defense rolls for 1d4 rounds.<br>Save: Dexterity DC 20 negates.<br>Heal: A DC 20 Acrobatics check removes the attack penalties.",
  ...
  $("button#g_magic").click(function () {
    ...
    const textArray = [
      "Your spell fails and you suffer a -4 penalty on attack rolls, saves, skill checks, and ability checks. <br>Save: Resolve DC 20 negates.<br>Heal: This effect can only be cured with remove curse.",
  ...
  $("button#b_slashing").click(function () {
    ...
    const textArray = [
      ...
      "Target suffers maximum damage and 1 Charisma damage. Target also suffers a -2 penalty on Perception checks until healed.<br>Save: A DC 20 Dexterity negates; deals bonus damage instead.<br>Heal: A DC 10 Heal check halves the Perception check penalties, while a DC 20 removes them. Rest or restorative magic is required to heal ability damage.",
      ...
      "Target suffers maximum damage and 1 Constitution damage. Target has a 25% chance of spell failure (-5 to spell casting rolls) with verbal components until healed.<br>Save: A DC 20 Constitution negates; deals bonus damage instead.<br>Heal: Rest or curative magic.",
      ...
      "Target suffers maximum damage and 1 Constitution and Charisma damage. Target also suffers a -2 Penalty to Perception checks and ranged attacks until healed.<br>Save: A DC 20 Dexterity negates; deals bonus damage instead.<br>Heal: A DC 20 Heal check removes the penalties to Perception and ranged attacks.",
      "Target suffers maximum damage and 1d6 Dexterity damage.<br>Save: A DC 20 Constitution halves Dexterity damage.<br>Heal: Rest or restorative magic.",
      ...
      "Target suffers maximum damage plus bonus damage again, 1d2 Constitution damage, and 1d4 bleed.<br>Save: A DC 20 Constitution halves the Constitution damage and bleed (minimum 1).<br>Heal: A DC 10 Heal check halves the bleed effect; a DC 20 Heal check negates the bleed effect. Rest or restorative magic is needed to heal ability damage.",
      "Target suffers maximum damage and 1d2 Dexterity damage. Target cannot use hand until healed.<br>Save: A DC 20 Dexterity save negates; deals bonus damage instead.<br>Heal: A DC 10 Heal check allows usage of hand, albeit with a -4 penalty to all rolls. A DC 20 Heal check repairs the hand’s use. Rest or restorative magic is needed to heal ability damage.<br><br>D10 - Injury<br>1-5 Left Hand<br>6-10 Right Hand",
      ...
      "Target suffers maximum damage plus 1d3 Strength damage.<br>Save: A DC 20 Constitution negates Strength damage; deals bonus damage instead.<br>Heal: Rest or restorative magic.",
      ...
      "Target suffers maximum damage plus bonus damage again and 1d4 bleed. Target cannot swallow whole food until healed.<br>Save: A DC 20 Constitution halves the bleed effect (minimum 1).<br>Heal: A DC 10 Heal check halves the bleed effect; a DC 20 Heal check ends it.",
      "Target suffers maximum damage and you gain a +4 bonus to Severity Checks against that opponent for the next three rounds.",
      "Target suffers maximum damage, and takes 1 Constitution and Strength damage.<br>Save: A DC 20 Dexterity negates; deals bonus damage instead.<br>Heal: Rest or Restoration spell.",
      "Target suffers maximum damage, and takes 1d2 Constitution and Strength damage. Target cannot use hand until healed.<br>Save: A DC 20 Constitution negates hand loss and ability drain becomes ability damage.<br>Heal: A DC 10 Heal check allows usage of hand, albeit with a -4 penalty to all rolls. A DC 20 Heal check repairs the hand’s use. Rest or restorative magic is needed to heal ability damage.<br><br>D10 - Injury<br>1-5 Left Hand<br>6-10 Right Hand",
      "Target suffers maximum damage, 1d2 Dexterity damage and is knocked prone.<br>Save: A DC 20 Dexterity save negates; deals bonus damage instead.<br>Recover: Target must spend a move-equivalent action to stand up. This provokes an attack of opportunity.",
      ...
      "Target suffers maximum damage and 1d2 Strength damage.<br>Save: A DC 20 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restoration spell.",
      ...
      "Target suffers maximum damage, 1d2 Dexterity damage, and becomes staggered for 1 round.<br>Save: A DC 20 Constitution negates Dexterity damage; deals bonus damage instead.<br>Heal: A DC 20 Heal check removes staggered condition.",
      ...
      "Target suffers maximum damage and 1 Constitution bleed.<br>Save: A DC 20 Constitution negates the bleed effect; deals bonus damage instead.<br>Heal: A DC 20 Heal check ends the Constitution bleed.",
      ...
      "Target suffers maximum damage and 1d2 Dexterity damage.<br>Save: A DC 20 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restoration spell.",
      ...
      "Target suffers maximum damage and 1 Constitution and Charisma damage.<br>Save: A DC 20 Dexterity negates ability damage; deals bonus damage instead.<br>Heal: Rest or restoration spell.",
      ...
      "Target suffers maximum damage and 1d3 Charisma damage.<br>Save: A DC 20 Constitution negates ability damage; deals bonus damage instead.<br>Heal: Rest or restoration spell.",
  ...
  $("button#b_piercing").click(function () {
    ...
    const textArray = [
      "Target suffers maximum damage and 1d2 Dexterity damage. Target’s movement speeds are reduced by half until healed.<br>Save: A DC 20 Constitution negates; deals bonus damage instead.<br>Heal: A DC 20 Heal check ends the movement penalty.",
  ...
  $("button#b_bludgeoning").click(function () {
    ...
    const textArray = [
      "Target suffers maximum damage and you deal normal damage to one adjacent target.<br>Save: Adjacent target may make a DC 20 Dexterity save to negate.<br>Special: If there are no adjacent targets, deal bonus damage to original target.",
  ...
  $("button#b_magic").click(function () {
    ...
    const textArray = [
      "Maximize all spell variables, and the target opponent within the spell's range suffers 1d2 damage to a random ability score.<br>Save: A DC 20 Constitution negates ability damage. If the spell targeted an opponent, DC 20 Resolve save negates maximized variables; but if the spell would deal damage, deal additional bonus damage instead.<br>Heal: Rest or restorative magic is needed to heal ability damage.<br><br>D6 - Ability Type Damage<br>1 - Strength<br>2 - Dexterity<br>3 - Constitution<br>4 - Intelligence<br>5 - Wisdom<br>6 - Charisma",
      ...
      "Maximize all spell variables, and if spell deals damage, each opponent who suffers damage also suffers 1d4 Dexterity damage.<br>Save: A DC 20 Resolve save negates the ability damage. If the spell targeted an opponent, a DC 20 Resolve save negates maximized variables; but if the spell would deal damage, deal additional bonus damage instead.<br>Special: If the spell would deal damage, its damage type becomes cold.<br>Heal: Rest or restorative magic is needed to heal ability damage.",
  ...
  $("button#m_piercing").click(function () {
    ...
    const textArray = [
      "Target suffers maximum damage and 1d3 Dexterity damage. Target’s movement speeds are reduced by half until healed.<br>Save: A DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check ends the movement penalty.",
  ...
  $("button#m_bludgeoning").click(function () {
    ...
    const textArray = [
      "Target suffers maximum damage and you deal normal damage to one adjacent target.<br>Save: Adjacent target may make a DC 25 Dexterity save to negate.<br>Special: If there are no adjacent targets, deal bonus damage to original target.",
      ...
      "Target suffers maximum damage, 1d2 Intelligence damage and is sickened for 1d3 rounds.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check removes the sickened condition. Rest or restoration magic is needed to heal ability damage.",
      "Target suffers maximum damage plus bonus damage again, and suffers either 1d3 Dexterity damage and half speed (leg), or 1d3 Strength damage (arm), and limb is useless until healed.<br>Save: DC 25 Constitution negates limb damage; deals bonus damage instead.<br>Heal: A DC 25 Heal check allows limb use and removes movement penalties. Rest or restoration magic is needed to heal ability damage.<br><br>D10 - Injury<br>1-5 Left Leg<br>6-10 Left Arm<br>11-15 Right Leg<br>16-20 Right Arm",
      ...
      "Target suffers maximum damage plus bonus damage again, plus 1d2 Dexterity and 1d2 Constitution damage, and target’s speeds are reduced by half until healed.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check removes the movement penalty, but rest or restorative magic is needed to heal ability damage.",
      "Target suffers maximum damage plus bonus damage again and cannot heal naturally for 1d2 days.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: Curative magic.",
      ...
      "Target suffers maximum damage plus bonus damage again and 1 Intelligence and Wisdom damage.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restorative magic.",
      "Target suffers maximum damage and 1d2 Dexterity damage. Target’s base land speed reduced to 10 feet until healed.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check removes the movement penalty, but rest or restorative magic is needed to heal ability damage.",
      "Target suffers maximum damage, 1d2 Constitution damage, and is fatigued.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: Rest and restorative magic.",
      ...
      "Target suffers maximum damage and 1 Constitution bleed.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: a DC 25 Heal check stops the Constitution Bleed, while Rest or restorative magic is needed to heal ability damage.",
      ...
      "Target suffers maximum damage plus bonus damage again and is pushed 1d3 squares directly away.<br>Save: DC 25 Strength negates; deals additional bonus damage instead.",
      ...
      "You deal maximum damage and gain a +3 circumstance bonus on all your attack rolls until the end of your next turn.",
      "Target suffers maximum damage and 1 Constitution damage. Target’s bite attacks are at a -2 penalty, and target suffers a 25% spell failure chance (-5 to casting rolls) for verbal spells.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check repairs teeth, removing bite penalty and removing the spell failure chance.",
      ...
      "Target suffers maximum damage and 1 Constitution and Strength damage. All attacks and skill checks using that hand suffer a -2 penalty.<br>Save: A DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check removes penalties, but rest or restorative magic is needed to heal ability damage.",
      "Target suffers maximum damage, 1d4 Charisma damage, and 1d4 bleed.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: A DC 25 Heal check heals the bleed effect, but rest or restorative magic is needed to heal ability damage.",
      ...
      "Target suffers maximum damage and 1d4 Intelligence damage.<br>Save: DC 25 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restoration magic.",
      ...
      "Target suffers maximum damage plus bonus damage again and 1 Intelligence damage.<br>Save: Constitution 25 negates; deals bonus damage instead.<br>Heal: Rest or restorative magic is needed to restore ability damage.",
      "Target suffers maximum damage plus bonus damage again and 1d4 hours of target’s memory is erased.<br>Save: DC 25 Constitution save negates; deals additional bonus damage instead.<br>Heal: A DC 25 Heal check restores target’s memory (no retry).",
  ...
  $("button#m_magic").click(function () {
    ...
    const textArray = [
      "Maximize all spell variables, and the target opponent within the spell's range suffers 1d4 damage to a random ability score.<br>Save: A DC 25 Constitution negates ability damage. If the spell targeted an opponent, DC 25 Resolve save negates maximized variables; but if the spell would deal damage, deal additional bonus damage instead.<br>Heal: Rest or restorative magic is needed to heal ability damage.<br><br>D6 - Ability Type Damage<br>1 - Strength<br>2 - Dexterity<br>3 - Constitution<br>4 - Intelligence<br>5 - Wisdom<br>6 - Charisma",
      ...
      'Maximize all spell variables, and you may give a target opponent within the spell\'s range 2 suggestions as the spell <a href="https://www.d20pfsrd.com/magic/all-spells/s/suggestion/">Suggestion</a>. <br>Save: A DC 25 Resolve save negates the suggestion. If the spell targeted an opponent, a DC 25 Resolve save negates maximized variables; but if the spell would deal damage, deal additional bonus damage instead.',
  ...
  $("button#s_slashing").click(function () {
    ...
    const textArray = [
      "Target suffers maximum damage and is blinded permanently.<br>Save: A DC 30 Dexterity save negates; deals bonus damage instead.<br>Heal: A Heal check DC 20 repairs sight somewhat, but the recipient treats all targets as though they have concealment (20%). A DC 30 heal check will fully repair eyesight to normal levels.",
  ...
  $("button#s_piercing").click(function () {
    ...
    const textArray = [
      "Target suffers maximum damage plus bonus damage again and 1d4 Dexterity damage. Target’s movement speeds are reduced by half until healed.<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: A DC 30 Heal check ends the movement penalty.",
      ...
      "Target suffers maximum damage plus bonus damage again and 1d4+1 Dexterity damage.<br>Save: A DC 30 Dexterity negates; deals bonus damage instead.<br>Heal: Rest or restorative magic.",
      ...
      "Target suffers maximum damage plus bonus damage again, 1d6 bleed, and 1 Constitution drain.<br>Save: A DC 30 Constitution negates Constitution drain and halves bleed effect; deals bonus damage instead.<br>Heal: A DC 30 Heal check removes the bleed effect. Rest or restoration magic is needed to heal ability damage.",
      ...
      "Target suffers maximum damage plus double bonus damage again and 1d2 Constitution drain. Target also suffers a -4 penalty on Perception checks and ranged attacks until healed.<br>Save: A DC 30 Dexterity negates; deals additional bonus damage instead.<br>Heal: A DC 30 Heal check removes the Perception and attack penalties.",
      ...
      "Target suffers maximum damage plus bonus damage again and 1d2 Dexterity damage. Target suffers a -4 penalty on all attack rolls and skill checks using that hand until healed.<br>Save: A DC 30 Dexterity negates; deals bonus damage instead.<br>Heal: A DC 30 Heal check is needed to end the wound penalty. Rest or restorative magic is needed to heal ability damage.",
      "Target’s heart ruptures and they immediately die.<br>Save: A DC 30 Constitution negates death; deals 2d4 Constitution drain and bonus damage instead.<br>Heal: Restorative magic is needed to heal ability drain.",
      ...
      "You deal maximum damage plus bonus damage again and gain a +3 circumstance bonus on all your attack rolls until the end of your next turn.",
      "Target suffers maximum damage plus bonus damage again, 1d4 Dexterity damage, and 1d4 Strength damage.<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restorative magic.",
      ...
      "Target suffers maximum damage plus bonus damage again and 1d6 Constitution damage.<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restorative magic is needed to heal ability damage.",
      ...
      'Target suffers maximum damage plus bonus damage again and is both sickened and poisoned (treat as <a href="https://www.d20pfsrd.com/gamemastering/afflictions/poison/greenblood-oil/">Greenblood Oil</a>).<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: A DC 30 Heal check removes the sickened condition. Target must succeed at a Constitution save to overcome the poison.',
      ...
      "Target suffers maximum damage plus bonus damage again, 1d2 Intelligence damage, and 1d4 bleed.<br>Save: A DC 30 Dexterity negates; deals bonus damage instead.<br>Heal: A DC 30 Heal check ends the bleed effect. Rest or restorative magic is needed to heal ability damage.",
      "Target suffers maximum damage plus bonus damage again, 1d4 Strength damage, and 1d4 Dexterity damage.<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restorative magic is needed to heal ability damage.",
      ...
      "Target suffers maximum damage plus bonus damage again, and you may make one additional free attack against the target at no penalty.",
      "Target suffers maximum damage plus bonus damage again and 1d4 Constitution damage. Target does not heal this ability damage naturally.<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: Target must receive restorative magic or pass a DC 30 Constitution save each day to recover a point of Constitution after resting.",
      "Target suffers maximum damage plus bonus damage again and 1 Constitution damage. Target gains 50% spell failure chance (-10 to spell casting rolls) for verbal spells until healed.<br>Save: A DC 30 Dexterity negates; deals bonus damage instead.<br>Heal: A DC 30 Heal check removes the spell failure chance. Rest or restorative magic is needed to heal ability damage.",
      ...
      "Target suffers maximum damage plus bonus damage again and takes 1d4 random ability damage.<br>Save: A DC 30 Constitution negates; deals bonus damage instead.<br>Heal: Rest or restorative magic is needed to heal ability damage.<br><br>D6 - Ability Type Damage<br>1 - Strength<br>2 - Dexterity<br>3 - Constitution<br>4 - Intelligence<br>5 - Wisdom<br>6 - Charisma",
    ];
  ...
  $("button#s_bludgeoning").click(function () {
    ...
    const textArray = [
      "Target suffers maximum damage plus bonus damage again, and you deal normal damage to one adjacent target.<br>Save: Adjacent target may make a DC 30 Dexterity save to negate.<br>Special: If there are no adjacent targets, deal bonus damage again to original target.",
